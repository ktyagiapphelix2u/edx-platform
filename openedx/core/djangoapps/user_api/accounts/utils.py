...
def redact_user_social_auth_pii(user_social_auth):
    ...
    This ensures proper data privacy by removing sensitive user information before deletion.
    When a user unlinks or retires, the SSO record is deleted from the LMS database. However,
    downstream systems may retain deleted records for audit or compliance purposes. This function
    redacts PII fields before deletion to prevent data retention issues.
